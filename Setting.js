...
global.owner = process.env.OWNER_NUMBER  || '94719014166' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://ravindu:#Rdjlover2005@cluster0.gfoc3id.mongodb.net/" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "94719014166" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"R Y G",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '01_04_2024_SIGMA_MD_pfpQnxSL_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'RAVINDU-MD',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `R Y GODAKANDA`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'RAVINDU_G',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "RY Godakanda" ,          // ADD YOUR STICKER PACKNAME
  ...
  warncount : process.env.WARN_COUNT || 5,                 // WARN LIMITS
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'9R6A2mdcAXdW0Iqhj2CAT3BlbkFJf0DyjGpnANOolCrpkGLR' ,    // ADD YOUR OPEN AI KEY IF YOU HAVE
