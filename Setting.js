...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://ravindu:#Rdjlover2005@cluster0.gfoc3id.mongodb.net/
...
module.exports = {
  ...
  ownername:  process.env.OWNER_NAME  || `RAVINDU`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'RAVINDU',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "RAvInDU" ,          // ADD YOUR STICKER PACKNAME
